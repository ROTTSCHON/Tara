...
function Text(){
    return(
            ...
            <div className="cards">
                         <div className="card">
                             <p>
                                We chose to set up a kennel because we are completely dedicated to dogs.
                                ...
                                We want to supply the market with quality dogs and we offer seriousness and respect in everything connected with this wonderful breed – Rottweiler.
                            </p> 
                        </div>
                    <div className="card">
                        <p>
                                ...
                                A well-bred Rottweiler is calm, confident, and courageous.We breed dogs with excellent temperament and no health problems.
                        </p>
                     </div>
                </div>
            </div>
